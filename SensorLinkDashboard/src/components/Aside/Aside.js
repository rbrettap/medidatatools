        ...
        <TabContent activeTab={this.state.activeTab}>
          <TabPane tabId="1">
            ...
            <div className="callout callout-warning m-0 py-3">
              <div className="avatar float-right">
                <img src={'img/avatars/7.jpg'} className="img-avatar" alt="admin@team27.com"/>
              </div>
              <div>Meeting with <strong>Adam</strong></div>
              <small className="text-muted mr-3"><i className="icon-calendar"></i>&nbsp; 1 - 3pm</small>
              <small className="text-muted"><i className="icon-location-pin"></i>&nbsp; New York, NY </small>
            </div>
            ...
            <div className="callout callout-info m-0 py-3">
              ...
              <div>Skype with <strong>Nolan</strong></div>
            ...
            <div className="callout callout-danger m-0 py-3">
              ...
              <small className="text-muted"><i className="icon-home"></i>&nbsp; Medidata HQ </small>
            ...
            <div className="callout callout-success m-0 py-3">
              <div><strong>#2 SensorLinks</strong> Meetup</div>
              <small className="text-muted mr-3"><i className="icon-calendar"></i>&nbsp; 1 - 3pm</small>
              <small className="text-muted"><i className="icon-location-pin"></i>&nbsp; New York, NY </small>
            </div>
            <hr className="mx-3 my-0"/>
            <div className="callout callout-primary m-0 py-3">
              ...
              <div className="avatars-stack mt-2">
                ...
                <div className="avatar avatar-xs">
                  <img src={'img/avatars/8.jpg'} className="img-avatar" alt="admin@team27.com"/>
                </div>
              </div>
            </div>
            <hr className="mx-3 my-0"/>
          ...
          <TabPane tabId="2" className="p-3">
            ...
            <div className="message">
              ...
              <div>
                <small className="text-muted">Richard Brett</small>
                <small className="text-muted float-right mt-1">1:52 PM</small>
              </div>
              <div className="text-truncate font-weight-bold">Lorem ipsum dolor sit amet</div>
              <small className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt...</small>
