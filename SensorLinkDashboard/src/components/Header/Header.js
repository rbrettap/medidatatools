          ...
          <li className="nav-item">
            <Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggle}>
              ...
              <DropdownMenu className="dropdown-menu-right">
                ...
                <DropdownItem><i className="fa fa-usd"></i> Events<span className="badge badge-default">42</span></DropdownItem>
                <DropdownItem><i className="fa fa-file"></i> Subjects<span className="badge badge-primary">42</span></DropdownItem>
