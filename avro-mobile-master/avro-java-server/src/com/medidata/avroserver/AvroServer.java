package com.medidata.avroserver;
...
import com.medidata.avroserver.protocol.v1.*;
...
public class AvroServer {
	...
	public static void main(String[] args) {
		try {
			if (args.length == 1) {
				...
				System.out.println("usage: java medidata-avro-server-1.0.jar <http port>");
			}
		} catch (Exception e) {
	...
	protected AvroRequest readRequest(InputStream is, String contentType)
		...
		if (contentType == null) {
			throw new IOException("Content type not set for Two Way Request");
		}
